...
export const reducer = ( state = new Map(), action: nodeActions.Actions ): NodeMap => {
	switch ( action.type ) {

		case nodeActions.ActionTypes.ADD_NODE:
			const addedNode = action.payload.node;
			return new Map( state ).set( addedNode.id, addedNode );

		case nodeActions.ActionTypes.REMOVE_NODE:
		...
		case nodeActions.ActionTypes.MOVE_NODE:
		...
		case nodeActions.ActionTypes.CONNECT_NODE:
		...
		case nodeActions.ActionTypes.DISCONNECT_NODE:
		...
		case nodeActions.ActionTypes.UPDATE_NODE:
