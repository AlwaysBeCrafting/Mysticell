export default {
	...
	fields: [ {
		...
		children: [ {
			...
			_id:      4,
			children: [
				{ name: 'Strength',     _id: 5,  children: [ { name: 'Modifier', _id: 6,  children: [] } ] },
				{ name: 'Dexterity',    _id: 7,  children: [ { name: 'Modifier', _id: 8,  children: [] } ] },
				{ name: 'Constitution', _id: 9,  children: [ { name: 'Modifier', _id: 10, children: [] } ] },
				{ name: 'Intelligence', _id: 11, children: [ { name: 'Modifier', _id: 12, children: [] } ] },
				{ name: 'Wisdom',       _id: 13, children: [ { name: 'Modifier', _id: 14, children: [] } ] },
				{ name: 'Charisma',     _id: 15, children: [ { name: 'Modifier', _id: 16, children: [] } ] },
			],
		},
		{
			name:     'Saves',
