...
const isBoundaryNode = (node: GraphNode): node is BoundaryNode => node.id === "input" || node.id === "output";
const isInnerNode = (node: GraphNode): node is InnerNode => !isBoundaryNode(node);
